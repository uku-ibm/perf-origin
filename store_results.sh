...
store_test_results()
{
        ...
        echo "_______________________________"
        sleep 1s
        echo " copying $workload.csv to TEMP_DIRECTORY/$testcase.csv "
        cp -rf $workload.csv TEMP_DIRECTORY/$testcase.csv
        echo " File content of TEMP_DIRECTORY/$testcase.csv "
        echo "_______________________________"
